...
public class main {
    public static void main(String[] args) {
        ...
        IndexWithDuplicatesParam<Integer> myIndex= new IndexWithDuplicatesParam(Integer.class);
        ...
        myIndex.initialize( new Integer[] {100, 50, 30, 50, 80, 100, 100, 30} ); // guarda 30 30 50 50 80 100 100 100
        myIndex.sortedPrint();
